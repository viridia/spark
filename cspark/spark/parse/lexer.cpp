...
namespace {
  ...
  typedef std::unordered_map<collections::StringRef, TokenType> KeywordMap;
  ...
  TokenType LookupKeyword(const collections::StringRef& tokenValue) {
